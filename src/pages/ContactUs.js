...
import contact_us_img from "../assets/images/contact-us-banner.png";
    ...
    <section>
      <HelmetProvider>
        <Helmet>
          ...
          <meta
            name="description"
            content="We'd love to hear from you. Get in touch using the form below or via the contact information provided."
          />
          ...
          <meta
            ...
            content={logo}
          />
          <meta property="og:url" content={configData.frontEndUrl + "contact-us"} />
          ...
          <meta
            ...
            content={logo}
          />
          <link rel="canonical" href={configData.frontEndUrl + "contact-us"} />
        </Helmet>
      </HelmetProvider>
            ...
            <div data-aos="zoom-out-left">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="input-box mt-3">
                  <button type="submit" className="prm-btn">
                    Submit
                  </button>
                </div>
              </form>
                ...
                <div class="content">
                  <div class="wrapper-1">
                    <div class="wrapper-2">
                      ...
                      <p>
                        Thanks for subscribing to our news letter. you should
